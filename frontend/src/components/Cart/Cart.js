                    ...
                    <div className="row d-flex justify-content-between">
                                    ...
                                    <div className="cart-item">
                                        <div className="row">
                                            ...
                                            <div className="col-4 col-lg-2 mt-4 mt-lg-0">
                                                <p id="card_item_price">{indianRupee(item.price)}</p>
                                            </div>

                                            <div className="col-4 col-lg-3 mt-4 mt-lg-0">
                                                <div className="stockCounter d-inline">
                                                    <span className="btn btn-danger minus" onClick={() => decreaseQty(item)}>-</span>
                                                    <input type="text" className="form-control count d-inline" value={item.quantity} readOnly />
                        ...
                        <div className="col-12 col-lg-3 my-4">
                            <div id="order_summary">
                                ...
                                <p>Est. total: <span className="order-summary-values">{indianRupee(items.reduce((acc, item) => (acc + item.quantity * item.price), 0))}</span></p>
