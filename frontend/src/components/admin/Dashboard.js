...
import { adminOrders as adminOrdersCount } from '../../actions/orderActions'
                        ...
                        <div className="col-xl-12 col-sm-12 mb-3">
                            <div className="card text-white bg-primary o-hidden h-100">
                                <div className="card-body">
                                    <div className="text-center card-font-size">Total Amount<br /> <b>{indianRupee(totalAmount)}</b>
                                    </div>
                                </div>
                            </div>
                        </div>
